...
<!-- styles -->
<div class="atts<?php if($dynamic_block) : echo ' dynamic-block'; endif; ?>">
	<ul class="atts-save">
		...
		<?php if(!$values['in_column'] && $this->edit_mode !== 'single-edit') : ?>
			...
			<?php if(!$values['dynamic_block']) : ?>
				<li>
					<a class="save-block" data-content-id="<?php echo $values['id']; ?>" data-content-type="<?php echo $this->content_type; ?>"></a>
					<div class="tooltip">
						<div class="tt-arrow">
							<?php echo set_ce_icon('tt-arrow'); ?>
						</div>
						<div class="tt-text">Save as Block</div>
					</div>
				</li>
			<?php endif; ?>
		<?php endif; ?>
		...
		<?php if(!$values['in_column'] && $this->edit_mode !== 'single-edit') : ?>
			<li class="save-align">
				<a class="save" data-content-id="<?php echo $this->id; ?>" data-content-type="<?php echo $this->content_type; ?>" data-dynamic-block="<?php echo $values['dynamic_block']; ?>">Save</a></li>

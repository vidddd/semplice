...
<?php endif; ?>
<?php if(get_field('social_networks_wnw', 'options')) : ?>
    <li><a class="wnw social-link" href="<?php echo get_field('social_networks_wnw', 'options'); ?>"  title="Working Not Working" target="_blank"><?php echo setIcon('wnw'); ?></a></li>
<?php endif; ?>
<?php if(get_field('social_networks_medium', 'options')) : ?>
    <li><a class="medium social-link" href="<?php echo get_field('social_networks_medium', 'options'); ?>"  title="Medium" target="_blank"><?php echo setIcon('medium'); ?></a></li>
<?php endif; ?>
<?php if(get_field('social_networks_vimeo', 'options')) : ?>
    <li><a class="vimeo social-link" href="<?php echo get_field('social_networks_vimeo', 'options'); ?>"  title="Vimeo" target="_blank"><?php echo setIcon('vimeo'); ?></a></li>
<?php endif; ?>